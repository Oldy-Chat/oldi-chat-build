...
final class Payload {
 ...
 static String preview(JSONObject m){String k=m.optString("kind","text");if(k.equals("file")){if(m.optBoolean("document"))return "📎 "+m.optString("name","Файл");if(m.optBoolean("custom_sticker"))return I18n.t("▣ Авторский стикер");String mime=m.optString("mime");return mime.startsWith("audio/")?I18n.t("🎙 Голосовое сообщение"):mime.startsWith("video/")?I18n.t("▶ Видео"):I18n.t("📷 Фото");}if(k.equals("sticker"))return "✨ "+m.optString("text",I18n.t("Анимированный эмодзи"));return m.optString("text");}
}
