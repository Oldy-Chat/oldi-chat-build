...
with tarfile.open(fileobj=buf,mode='w:gz') as t:
 for f in ('server.py','account_features.py','sticker_generation.py','configure-stickers.py','sticker_diagnostics.py','install.sh','configure-mail.py','disk_storage.py','configure-disk.py','legal_service.py','legal_texts.json','configure-legal.py','retention.py'):t.add(root/'server'/f,arcname=f)
