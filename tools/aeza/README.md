# Status during source migration

The VPS check workflow is disabled. No VPS access is required for Android/server CI.
Aéza 2.56.174.123 is reserved for future YouTube and sticker services.
No deployment, YouTube playback, or live sticker generation is verified by this migration.
The former setup notes below are retained for future work, not current setup instructions.
...
https://github.com/Oldy-Chat/oldi-chat-build/settings/secrets/actions :
