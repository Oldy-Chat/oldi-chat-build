...
исправлениями CI. Новый кандидат: versionCode 15, пакет `chat.oldy`.
Состояние переноса: [MIGRATION.md](MIGRATION.md).
Изменения и проверка выпуска: [RELEASE-0.6.6.md](RELEASE-0.6.6.md).
...
Для YouTube используется системная браузерная сессия с открытием внутри приложения
и отдельный встроенный плеер. Первый вход Google и системное разрешение Android
